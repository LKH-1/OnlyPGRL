...
class PPOTrain:
    def __init__(self, sess, Policy, Old_Policy, gamma=0.95, clip_value=0.2, c_1=1, c_2=0.01):
        self.sess = sess
        self.Policy = Policy
        ...
        with tf.variable_scope('train_inp'):
            ...
            self.v_preds_next = tf.placeholder(tf.float32, [None], name='v_preds_next')
